...
<?php
include 'db.php';
$library = "SELECT * FROM parameterlibrary";
...
<div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="parameterlibrarylet.php?paralib_ID=<?php echo $row['paralib_ID']; ?>"><img src="photos/folder.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
	<?php echo $row['libpara_let']; ?>
    </div>
  </div>
</div>
