...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
	<title>PUP BATAAN CITIZEN'S CHARTER</title>
</head>
<body>
	<section>
		<div class="header">
...
<!-- <div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="charter_docu.php?exhibitID=1" target="_blank"><img src="photos/pdf.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
	Citizen's Charter
    </div>
  </div>
</div> -->
...
<?php include 'db.php';
	...
	$exhibitID_query = "SELECT * FROM exhibit WHERE exhibitID= 1";
