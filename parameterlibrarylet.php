...
<div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="libraryparameterSIP.php?paralib_ID=<?php echo $paralib_ID; ?>" target="_blank"><img src="photos/pdf.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
...
<div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="libraryparameterimp.php?paralib_ID=<?php echo $paralib_ID; ?>"target="_blank"><img src="photos/pdf.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
	Implementation
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="libraryparameteroutcome.php?paralib_ID=<?php echo $paralib_ID; ?>"target="_blank"><img src="photos/pdf.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
	Outcome
    </div>
  </div>
</div>
