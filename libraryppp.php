...
<?php
include 'db.php';
$library = "SELECT sslibraryID, ppp FROM sslibrary";
...
<div class="card mb-3" style="max-width: 1200px; margin-left:100px">
  <div class="row g-0">
    <div class="col-md-4">
	<a href="librarypppview.php?sslibraryID=<?php echo $row['sslibraryID']; ?>" target="_blank"><img src="photos/pdf.png" class="img-fluid rounded-start" alt="..." width="10%"></a>
