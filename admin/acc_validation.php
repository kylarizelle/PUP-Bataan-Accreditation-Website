...
<?php	unset($_SESSION['error']);			
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="lastname_" value="<?php echo $_SESSION['lastname_']; ?>">
        <label  class="form-label">First Name:</label>
        <input type="text" class="form-control" name="firstname_" value="<?php echo $_SESSION['firstname_']; ?>">
        <label  class="form-label">Middle Initial:</label>
        <input type="text" class="form-control" name="mi_" value="<?php echo $_SESSION['mi_']; ?>">
        <label  class="form-label">Username:</label>
        <input type="text" class="form-control" name="username" value="<?php echo $_SESSION['username']; ?>">
        <label  class="form-label">Password <small>(for validation)</small>: </label>
