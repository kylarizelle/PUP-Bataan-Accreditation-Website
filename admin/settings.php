...
<div class="update">
    <a href="acc_validation.php?adminID=<?php echo $_SESSION['id'] ?>"><button type="button" class="btn btn-primary">Change Account Information</button></a>
    <br>
    <br>
    <a href="change_password.php?adminID=<?php echo $_SESSION['id'] ?>"><button type="button" class="btn btn-primary">Change Password</button></a>
</div>
