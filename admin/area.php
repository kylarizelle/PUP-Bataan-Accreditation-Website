...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  <a href="area.php"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></a>
</div>
</div>
<?php } ?>
					...
					While($row = mysqli_fetch_assoc($run)) {
						?>
							<tr>
									...
									<?php echo "<td><img src='../admin/photos/".$row['area_img']." 'width='60' height='60'/></td>" ?>
									<td><a href="area_edit.php?areaID=<?php echo $row['areaID']; ?>"><button class='edit-administration'><i class='fa fa-pencil'></i></button></a><a href="crudadministration.php?areaID=<?php echo $row['areaID']; ?>"><button class='delete-administration'><i class='fa fa-trash'></i></button></a></td>
...
<div class="pop-up" id="add_administration_modal" tabindex="-1" role="dialog" aria-labeelledby="administration_modal" aria-hidden="true">
	<div class="overlay" role="document">
		...
		<form action = "crudadministration.php"method="post" enctype="multipart/form-data">
				...
				<input type="file" name="area_img" class="form-control">
				<button name="add_area" class="add_save add-administration">Save</button>
		</form>
	</div>
</div>
